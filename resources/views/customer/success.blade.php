...
<div class="container-fluid fruite py-5 d-flex justify-content-center ">
    <div class="receipt border p-4 bg-white shadow" style="width: 450px; margin-top: 5rem;">
        ...
        <table class="table table-borderless">
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-end">Rp{{ number_format($orderItem->item->price, 0, ',','.') }}</td>
        ...
        @endif
        <hr>
        <a href="{{route('menu')}}" class ="btn btn-primary w-100">Kembali ke Menu <i class="fa fa-arrow-right ms-2"></i></a>
    </div>
