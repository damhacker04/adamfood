            ...
            <div class="container py-5">
                <div class="pb-4 mb-4" style="border-bottom: 1px solid rgba(226, 175, 24, 0.5) ;">
                    <div class="row g-4">
                        <div class="col-lg-6">
                            <a href="#">
                                <h1 class="text-primary mb-0">Adamfood</h1>
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="footer-item">
                            ...
                            <p>Alamat: Jl. Harun No. 32B, Tanah Kusir, Kec. Kebayoran Lama, Kota Jakarta Selatan, Jakarta 12240</p>
                            <p>Email: adamemier16@gmail.com</p>
                            <p>Telp: 0812-2682-8170</p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        <span class="text-light"><a href="#"><i class="fas fa-copyright text-light me-2"></i>Adamfood</a> <span id="currentYear"></span>. All right reserved.</span>
                    </div>
